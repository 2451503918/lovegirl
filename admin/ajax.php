        ...
        $.ajax({
            ...
            success: function (res) {
                if (res === "1") {
                    ...
                    setTimeout(function(){ window.location.href='littleSet.php'; }, 1000);
                } else if (res === "0") {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res === "1") {
                    ...
                    setTimeout(function(){ window.location.href='loveImgSet.php'; }, 1000);
                } else if (res === "0") {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res === "1") {
                    ...
                    setTimeout(function(){ window.location.href='lovelist.php'; }, 1000);
                } else if (res === "0") {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res === "1") {
                    ...
                    setTimeout(function(){ window.location.href='ipList.php'; }, 1000);
                } else if (res === "0") {
